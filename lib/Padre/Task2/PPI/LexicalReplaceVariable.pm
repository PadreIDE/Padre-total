package Padre::Task2::PPI::LexicalReplaceVariable;
...
Padre::Task2::PPI::LexicalReplaceVariable - Lexically variable replace using L<PPI>

=head1 SYNOPSIS

  my $replacer = Padre::Task2::PPI::LexicalReplaceVariable->new(
