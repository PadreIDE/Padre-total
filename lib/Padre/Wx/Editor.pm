...
use Wx   qw(wxTELETYPE wxNORMAL wxSTC_STYLE_DEFAULT wxSTC_H_TAG wxLayout_LeftToRight
			wxSTC_PL_DEFAULT wxSTC_PL_ERROR wxSTC_PL_COMMENTLINE wxSTC_PL_POD wxSTC_PL_NUMBER 
			wxSTC_PL_WORD wxSTC_PL_STRING wxSTC_PL_CHARACTER wxSTC_PL_PUNCTUATION 
			wxSTC_PL_PREPROCESSOR wxSTC_PL_OPERATOR wxSTC_PL_IDENTIFIER wxSTC_PL_SCALAR 
			wxSTC_PL_ARRAY wxSTC_PL_HASH wxSTC_PL_REGEX wxSTC_PL_REGSUBST wxSTC_PL_HERE_Q 
			wxSTC_PL_STRING_Q wxSTC_PL_STRING_QQ wxSTC_PL_SYMBOLTABLE wxSTC_PL_LONGQUOTE
			wxSTC_PL_BACKTICKS wxSTC_PL_DATASECTION wxSTC_PL_HERE_DELIM wxSTC_PL_HERE_QQ
			wxSTC_PL_HERE_QX wxSTC_PL_STRING_QX wxSTC_PL_STRING_QR wxSTC_PL_STRING_QW
	);
