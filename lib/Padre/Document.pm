...
our %MIME_CLASS = (
	...
	'application/ecmascript' => 'Padre::Document::JavaScript',
);
...
our %MIME_LEXER = (
	...
	'application/ecmascript' => Wx::wxSTC_LEX_ESCRIPT,
	...
	'application/x-python'   => Wx::wxSTC_LEX_PYTHON,
