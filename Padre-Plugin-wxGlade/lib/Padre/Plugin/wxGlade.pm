...
sub menu_plugins_simple {
	...
	return $self->plugin_name => [
		...
		'New Dialog from wxGlade Perl' => sub {
			$self->new_dialog_from_perl;
		},
	];
}
...
sub new_dialog_from_perl {
	my $self = shift;

	# Load the wxGlade-generated Perl file
	my $perl = $self->load_perl or return;

	# Create a new document
	$self->main->new_document_from_string( $$perl, 'application/x-perl' );
