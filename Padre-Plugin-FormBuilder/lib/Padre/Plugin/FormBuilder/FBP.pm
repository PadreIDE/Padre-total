...
sub new {
	...
	my $m_bitmap3 = Wx::StaticBitmap->new(
		$self,
		-1,
		Wx::Bitmap->new( "share/wxfb.png", Wx::wxBITMAP_TYPE_ANY ),
		Wx::wxDefaultPosition,
		Wx::wxDefaultSize,
	);
	...
	my $m_bitmap1 = Wx::StaticBitmap->new(
		$self,
		-1,
		Wx::Bitmap->new( "share/single.png", Wx::wxBITMAP_TYPE_ANY ),
		Wx::wxDefaultPosition,
		Wx::wxDefaultSize,
	);
	...
	my $m_bitmap2 = Wx::StaticBitmap->new(
		$self,
		-1,
		Wx::Bitmap->new( "share/common.png", Wx::wxBITMAP_TYPE_ANY ),
		Wx::wxDefaultPosition,
		Wx::wxDefaultSize,
	);
