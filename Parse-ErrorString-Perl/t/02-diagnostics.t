...
ok($errors_compile[0]->line == 5, 'msg_compile line');
...
ok($errors_runtime[0]->line == 6, 'msg_runtime 1 line');
...
ok($errors_runtime[1]->line == 9, 'msg_runtime 2 line');
...
ok($errors_near[0]->line == 8, 'msg_near 1 line');
...
ok($errors_near[1]->line == 8, 'msg_near 2 line');
...
ok($errors_at[0]->line == 5, 'msg_at 1 line');
...
ok($errors_at[1]->line == 5, 'msg_at 2 line');
