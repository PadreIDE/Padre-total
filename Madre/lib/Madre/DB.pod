...
Madre::DB - An ORLite-based ORM Database API
...
=head2 pragma
  ...
  my $version = Madre::DB->pragma('user_version');
...
B<Madre::DB> is based on L<ORLite>.
