...
ok( $master->is_running, 'Thread is_running' );
ok( ! $master->is_joinable, 'Thread is not is_joinable' );
ok( ! $master->is_detached, 'Thread is not is_detached' );
...
sleep 1;
ok( ! $master->is_running,  'Thread is not is_running' );
ok(   $master->is_joinable, 'Thread is_joinable' );
ok( ! $master->is_detached, 'Thread is not is_detached' );
