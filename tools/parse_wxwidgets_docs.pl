...
The pod is derived from wxWidgets HTML documentation which is
...
It is licensed under wxWindows Library License version 3.1
L<http://docs.wxwidgets.org/2.8.10/wx_wxlicense.html> and GNU Library
General Public License version 2
L<http://docs.wxwidgets.org/2.8.10/wx_gnulicense.html>.

This file is generated by C<parse_wxwidgets_docs.pl>. It is found at
L<http://svn.perlide.org/padre/trunk/tools/parse_wxwidgets_docs.pl>.

The original HTML documentation ZIP file is found at
